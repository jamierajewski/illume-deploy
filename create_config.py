...
def create_ssh_config(data, outfile, special_config_name=None):
    ...
    filein = open("packer/roles/common/files/ssh.cfg.template")
    ...
    filein = open("packer/roles/common/files/ssh.cfg.template.per_host")
    src = Template(filein.read())
    del filein
...
def main():
    ...
    create_ssh_config(data, outfile="packer/roles/common/files/ssh.cfg")
